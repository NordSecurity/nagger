...
See relevant [README](README.md#requirements) section.
## PR Workflow
...
The local feedback cycle is faster than waiting for the CI. Make sure your changes can be built locally and that all tests pass locally. 
...
## Licensing
Nagger is released under MIT License. For more details please refer to [LICENSE](LICENSE) file.
## Contributing Documents
Before we can accept your pull request we may need you to submit documents (e.g., DCO) that either be provided automatically or manually by us.
